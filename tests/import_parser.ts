...
function parseImport(matches: string): string {
  ...
  names.forEach(name => {
    switch (name) {
      ...
      case 'Tags':
      case 'OperationId':
        outputs[`decorators/${name.toLowerCase()}`].push(name);
        break;
      case 'Body':
      case 'BodyProp':
      case 'Request':
      ...
      case 'FormField':
      case 'Consumes':
        outputs['decorators/parameter'].push(name);
        break;
      case 'Options':
      case 'Get':
      case 'Post':
      ...
      case 'Delete':
      case 'Head':
        outputs['decorators/methods'].push(name);
        break;
      case 'Res':
      case 'Response':
      case 'SuccessResponse':
      case 'Produces':
        outputs['decorators/response'].push(name);
        break;
      case 'Route':
      case 'Hidden':
        outputs['decorators/route'].push(name);
        break;
      case 'Security':
      case 'NoSecurity':
        outputs['decorators/security'].push(name);
        break;
      case 'Extension':
      case 'ExtensionType':
        outputs['decorators/extension'].push(name);
        break;
      case 'Middlewares as GenericMiddlewares':
        outputs['decorators/middlewares'].push(name);
        break;
      case 'Controller':
        outputs['interfaces/controller'].push(name);
        break;
      case 'TsoaResponse':
        outputs['interfaces/response'].push(name);
        break;
      case 'File':
        outputs['interfaces/file'].push(name);
        break;
      case 'IocContainerFactory':
      case 'IocContainer':
        outputs['interfaces/iocModule'].push(name);
        break;
      case 'Swagger':
        outputs['swagger/swagger'].push(name);
        break;
      case 'Tsoa':
        outputs['metadataGeneration/tsoa'].push(name);
        break;
      case 'TsoaRoute':
        outputs['routeGeneration/tsoa-route'].push(name);
        break;
      case 'FieldErrors':
      case 'ValidationService':
      case 'ValidateError':
        outputs['routeGeneration/templateHelpers'].push(name);
        break;
      case 'AdditionalProps':
        outputs['routeGeneration/additionalProps'].push(name);
        break;
      case 'Config':
        outputs['config'].push(name);
        break;
      default:
        outputs['unknown'].push(name);
        break;
    }
  });
...
function replaceImport(filePath: string): void {
  ...
  const matches = data.match(/import \{ (.*?) \} from '@tsoa\/runtime';/);
  if (matches === null) {
    return;
  }
