...
@CustomMethodAttribute('x-attKey', 'attValue')
@CustomMethodAttribute('x-attKey1', { test: 'testVal' })
@CustomMethodAttribute('x-attKey2', ['y0', 'y1'])
@CustomMethodAttribute('x-attKey3', [{ y0: 'yt0', y1: 'yt1' }, { y2: 'yt2' }])
@CustomMethodAttribute('x-testPath', '{$PATH}')
@CustomMethodAttribute('x-testMethod', '{$METHOD}')
export class CustomMethodAttributeController extends Controller {

    @Get('CustomAttribute')
    @CustomAttribute('x-additionalAttribute', 'value')
